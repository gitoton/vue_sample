        ...
        <div class="container">
            ...
            <div class="current-num">
                <div class="num-circle" :class="checkCurrentPage(1)">
                    {{ checkCurrentPage(1)['passed-page'] ? "✔️" : 1 }}
                </div>
                <div class="num-circle" :class="checkCurrentPage(1)">
                    {{ checkCurrentPage(2)['passed-page'] ? "✔️" : 2 }}
                </div>
                <div class="num-circle" :class="checkCurrentPage(1)">
                    {{ checkCurrentPage(3)['passed-page'] ? "✔️" : 3 }}
                </div>
                <div class="num-circle" :class="checkCurrentPage(1)">
                    {{ checkCurrentPage(4)['passed-page'] ? "✔️" : 4 }}
                </div>
            </div>
            <!-- １ページ目のコンテンツの表示 -->
            ...
            <div class="select">
                ...
                <section class="mt20 w80">
                    ...
                    <div data-field="メールアドレス" data-validate="email">
                        <input type="email" inputmode="email" name="email" autocapitalize="off" class="w100" v-model="customer.email">
                    </div>
                </section>
            </div>

            <div class="error_msg" v-show="error_name">【お名前】は必須項目です。入力内容をご確認ください。</div>
            <div class="error_msg" v-show="error_email_require">【メールアドレス】必須項目です。入力内容をご確認ください。</div>
            <div class="error_msg" v-show="error_email_format">【メールアドレス】フォーマットが不正です。入力内容をご確認ください。</div>
    ...
    export default {
        setup () {
            ...
            const checkEmail = mail => {
                // 正規表現を使って xxx@xxx.xxxの様なフォーマットになっているかチェック
